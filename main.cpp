...
void playObstacleCollisionSound() {
	PlaySound(TEXT("obstacle-collide.wav"), NULL, SND_FILENAME | SND_ASYNC);
}

void playPowerUpCollisionSound() {
...
void main(int argc, char** argv) {
	...
	loadBMP(&stars, "textures/stars.bmp", true);
	loadBMP(&lightSpeed, "textures/light_speed.bmp", true);
